...
echo "    curl -fsSL https://raw.githubusercontent.com/KiberSlesar/hermes-agent-MongoDB-private/main/install/db-connect.sh | bash -s -- --host ${ADVERTISE}:${PORT} --code ${CODE}"
echo "========================================================"
echo ""
